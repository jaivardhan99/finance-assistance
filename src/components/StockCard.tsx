...
const StockCard: React.FC<StockCardProps> = ({ 
  ...
  return (
    <div
      className="relative w-full h-56 md:h-60 cursor-pointer [perspective:1000px] group"
      onClick={handleClick}
      ...
      >
        ...
        >
          ...
          <div className="flex border-b border-slate-600 mb-3">
            <button 
              className={`px-3 py-1 text-sm ${activeTab === 'details' ? 'border-b-2 border-blue-400 font-semibold' : 'text-gray-400'}`}
              onClick={(e) => {
                e.stopPropagation();
            ...
            <button 
              className={`px-3 py-1 text-sm ${activeTab === 'news' ? 'border-b-2 border-blue-400 font-semibold' : 'text-gray-400'}`}
              onClick={(e) => {
                e.stopPropagation();
                setActiveTab('news');
              }}
